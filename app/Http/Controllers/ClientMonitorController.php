...
class ClientMonitorController extends Controller
{
    ...
    {
        $client_monitors = ClientMonitorResource::collection(ClientMonitor::with('company', 'seller', 'oportunity', 'paymentMonitor', 'mettingMonitor', 'whatsappMonitor')->latest()->get());

                ...
                <div class="flex items-center space-x-2">
                    ...
                    placement="top">
                        <Link :href="route('invoices.edit', selectedInvoice)">
                            <button v-if="!handleDisable || invoice.number_of_invoice == 1" class="size-9 flex items-center justify-center rounded-[10px] bg-[#D9D9D9] dark:bg-[#202020] dark:text-white">

    ...
    <AppLayout title="Órdenes de compra - Editar">
      ...
      <form @submit.prevent="update">
        <div class="md:w-1/2 md:mx-auto grid grid-cols-2 gap-3 mx-3 my-5 bg-[#D9D9D9] dark:bg-[#202020] dark:text-white rounded-lg p-9 shadow-md">
          ...
          <div v-else class="flex items-center space-x-2 mt-5">
            <span class="text-sm">Obteniendo información bancaria...</span>
          ...
          <div v-else class="flex items-center space-x-2 mt-5">
            <span class="text-sm">Obteniendo contacto...</span>
            <i class="fa-solid fa-circle-notch fa-spin text-lg"></i>
          </div>
          <div>
          ...
          <div>
            <el-checkbox @change="handleCheckShowPrices" v-model="form.show_prices" label="Mostar precios"
              size="small" />

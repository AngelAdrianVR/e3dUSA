  ...
  <div class="h-screen bg-[#F2F2F2]">
    ...
    <form v-if="!is_sent" @submit.prevent="store">
      <div class="md:w-1/2 md:mx-auto mt-20 bg-transparent rounded-lg lg:p-9 p-4 space-y-4">
        ...
        <p class="mt-3">En Emblemas 3d USA valoramos mucho tu opinión y nos gustaría conocer tus comentario para seguir mejorando.</p>
        <p class="mt-3">1. En una escala del 0 al 10, ¿qué tan satisfecho/a estás con la calidad de nuestros productos?</p>
        <div class="w-full">
        ...
        <div class="flex space-x-7 items-center lg:ml-5">
          <label>
          <input v-model="form.p2" :value="true" type="radio" name="group1" class="mr-1 bg-transparent border-black checked:bg-primary focus:ring-primary focus:text-primary hover:text-red-500"> Sí
          </label>
          <label>
          <input v-model="form.p2" :value="false" type="radio" name="group1" class="mr-1 bg-transparent border-black checked:bg-primary focus:ring-primary focus:text-primary hover:text-red-500"> No
          </label>
        ...
        <div class="flex space-x-7 items-center lg:ml-5">
          <label>
          <input v-model="form.p3" :value="true" type="radio" name="group2" class="mr-1 bg-transparent border-black checked:bg-primary focus:ring-primary focus:text-primary hover:text-red-500"> Sí
          </label>
          <label>
          <input v-model="form.p3" :value="false" type="radio" name="group2" class="mr-1 bg-transparent border-black checked:bg-primary focus:ring-primary focus:text-primary hover:text-red-500"> No
          </label>
        ...
        <div class="flex space-x-7 items-center lg:ml-5">
          <label>
          <input v-model="form.p4" :value="true" type="radio" name="group3" class="mr-1 bg-transparent border-black checked:bg-primary focus:ring-primary focus:text-primary hover:text-red-500"> Sí
          </label>
          <label>
          <input v-model="form.p4" :value="false" type="radio" name="group3" class="mr-1 bg-transparent border-black checked:bg-primary focus:ring-primary focus:text-primary hover:text-red-500"> No
          </label>

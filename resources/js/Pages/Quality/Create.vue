            ...
            <div class="mt-14" v-for="(product, index) in productionObj.catalog_product_company_sales" :key="index">
                ...
                <div class="flex space-x-3 mt-2">
                    ...
                    <div class="w-full">
                        ...
                        <input v-model="form.product_inspection[index].pieces" type="number" step="0.1" class="input" />
    ...
    try {
        ...
        if (response.status === 200) {
          this.productionObj = response.data.item;
            ...
            this.productionObj.catalog_product_company_sales.forEach(() => {

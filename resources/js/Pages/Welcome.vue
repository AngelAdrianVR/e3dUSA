...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 darkk:bg-dots-lighter darkk:bg-gray-900 selection:bg-red-500 selection:text-white">
        <div v-if="canLogin" class="z-10 text-4xl">
            <Link v-if="$page.props.auth.user" :href="route('dashboard')" class="font-semibold text-gray-600 hover:text-gray-900 darkk:text-gray-400 darkk:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Ir al panel de inicio</Link>

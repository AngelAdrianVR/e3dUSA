    ...
    <div v-if="tabs == 1" class="md:grid grid-cols-2 border-b-2 border-[#cccccc] dark:text-white text-sm">
      <div
        ...
        <a class="text-secondary hover:underline"
          :href="route('oportunities.show', email_monitor.data.oportunity?.id)">
          <span>{{ email_monitor.data.oportunity?.folio }} - {{ email_monitor.data.oportunity?.name }}
          </span>
        </a>
        <p class="text-secondary col-span-2 mt-5 mb-2 self-start">Información del correo electrónico</p>
        ...
        <span class="text-gray-500">Enviado a</span>
        <span>{{ email_monitor.data.contact_name }}</span>
        <span class="text-gray-500">Correo del contacto</span>
        ...
        <span class="text-gray-500">Enviado el</span>

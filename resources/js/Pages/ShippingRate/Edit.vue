        ...
        <div class="md:w-1/2 md:mx-auto mx-3 my-5 bg-[#D9D9D9] rounded-lg py-4 px-9 shadow-md space-y-4">
            ...
            <section class="grid grid-cols-3 gap-5">
                ...
                <figure class="border border-[#999999] flex items-center justify-center rounded-lg h-40">
                  ...
                  <div class="h-full" v-else>
                    ...
                    <img v-if="catalogProductSelected" class="object-contain h-full" :src="catalogProductSelected.media[0].original_url" alt="Producto de catálogo">
                  </div>
                </figure>
            </section>
            ...
            <section class="pt-7">
              <article class="flex justify-between mb-3">
                ...
                <!-- tarjeta de cajas -->
                <article v-for="(packageCard, index) in form.boxes" :key="packageCard" class="rounded-lg py-5 px-2" :class="index % 2 === 0 ? 'bg-[#C0C0C0]' : 'bg-[#9F9FA2]'" >
                  <div class="mb-3">
                    <div class="flex justify-between">
                      ...
                      <el-select class="w-full" filterable v-model="form.boxes[index].box_id" @change="fillBoxSizes(index, form.boxes[index].box_id)"
                          placeholder="Seleccione" no-data-text="No hay opciones registradas"
                          no-match-text="No se encontraron coincidencias">
                          ...
                          <el-option v-for="item in box_types" :key="item" :label="item.name" :value="item.id">
                              <p class="flex items-center justify-between">
                                  <span>{{ item.name }}</span>
                                  <span class="text-[10px] text-gray99">({{ 'L-' + item.length + 'cm x ' + 'An-' + item.width + 'cm x ' + 'Al-' + item.height + 'cm' }})</span>
                              </p>
                          </el-option>
                      </el-select>
                  ...
                  <section class="grid grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <el-input
                        v-model="form.boxes[index].width" placeholder="Ancho">
                        <template #append>cm</template>
                      </el-input>
                    ...
                    <div>
                      ...
                      <el-input
                        v-model="form.boxes[index].height" placeholder="Alto">
                        <template #append>cm</template>
                      </el-input>
                    ...
                    <div>
                      ...
                      <el-input
                        v-model="form.boxes[index].weight" placeholder="Peso">
                    ...
                    <div>
                      <InputLabel value="Cantidad*" />
                      <el-input
                        v-model="form.boxes[index].quantity" placeholder="Cantidad">
                        <template #append>unidades</template>
                      </el-input>
            ...
            <form>
              ...
              <div class="grid grid-cols-3 gap-3 mt-3">
                <div>
                  <InputLabel value="Largo*" />
                  <el-input
                    v-model="boxForm.length" placeholder="Largo">
                    <template #append>cm</template>
                  </el-input>
                ...
                <div>
                  <InputLabel value="Ancho*" />
                  <el-input
                    v-model="boxForm.width" placeholder="Ancho">
                    <template #append>cm</template>
                  </el-input>
                ...
                <div>
                  <InputLabel value="Alto*" />
                  <el-input
                    v-model="boxForm.height" placeholder="Alto">
                    <template #append>cm</template>
                  </el-input>

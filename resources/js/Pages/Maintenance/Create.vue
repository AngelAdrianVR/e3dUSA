<template>
  <div>
    <AppLayout title="Mantenimiento - Crear">
      <template #header>
        ...
        <div class="md:w-1/2 md:mx-auto mx-3 my-5 bg-[#D9D9D9] rounded-lg p-9 shadow-md space-y-4">
          ...
          <div v-if="form.maintenance_type == 'Correctivo'">
            <div class="flex col-span-full">
              <el-tooltip content="Problemas o causas del mantenimiento" placement="top">
                <span
              ...
              <textarea v-model="form.problems" class="textarea" autocomplete="off"
                placeholder="Problemas *"></textarea>
              <InputError :message="form.errors.problems" />
            </div>
          </div>
          <div v-if="form.maintenance_type != 'Limpieza'">
            <div class="flex col-span-full">
              <el-tooltip content="Descripción de lo que se le hizo a la máquina" placement="top">
                <span
                  class="font-bold text-[16px] inline-flex items-center text-gray-600 border border-r-8 border-transparent rounded-l-md h-9 darkk:bg-gray-600 darkk:text-gray-400 darkk:border-gray-600">
                  ...
                </span>
              </el-tooltip>
              <textarea v-model="form.actions" class="textarea" autocomplete="off" placeholder="Acciones *"></textarea>
          ...
          <div>
            <IconInput v-model="form.responsible" inputPlaceholder="Responsable *" inputType="text">

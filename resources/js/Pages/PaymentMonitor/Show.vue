<template>
  <AppLayoutNoHeader title="Seguimiento de pagos">
    ...
    <div v-if="tabs == 1" class="md:grid grid-cols-2 border-b-2 border-[#cccccc] text-sm">
      <div class="grid grid-cols-2 text-left p-4 md:ml-10 border-r-2 border-gray-[#cccccc] items-center *:self-start self-start gap-1">
        ...
        <a class="text-secondary hover:underline"
          :href="route('oportunities.show', payment_monitor.data.oportunity?.id)">
      ...
      <div class="grid grid-cols-2 gap-1 text-left p-4 md:ml-10">
        <p class="text-secondary col-span-full mb-2">Datos del pago</p>

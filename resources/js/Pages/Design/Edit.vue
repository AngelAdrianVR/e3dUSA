        ...
        <div class="md:w-1/2 md:mx-auto mx-3 my-5 bg-[#D9D9D9] rounded-lg p-9 shadow-md space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-3">
            ...
            <div v-if="form.original_design_id == 'Nuevo diseño'">
              <IconInput v-model="form.company_branch_name" inputPlaceholder="Cliente" inputType="text">
            ...
            <div v-if="form.original_design_id == 'Nuevo diseño'">
              <IconInput v-model="form.contact_name" inputPlaceholder="Contacto" inputType="text">
            ...
            <div class="col-span-2" v-if="form.original_design_id == 'Registrado'">
              <el-select v-model="form.company_branch_name" clearable filterable placeholder="Selecciona un cliente"
                no-data-text="No hay clientes registrados" no-match-text="No se encontraron coincidencias">
                <el-option v-for="item in companies" :key="item.id" :label="item.business_name"
            ...
            <div>
              <IconInput v-model="form.name" inputPlaceholder="Nombre del diseño" inputType="text">
            ...
            <div>
              <IconInput v-model="form.dimensions" inputPlaceholder="Medidas (Dimensiones)" inputType="text">
                <el-tooltip content="Medidas (Dimensiones)" placement="top"> <i class="fa-solid fa-text-width"></i>
                </el-tooltip>
              </IconInput>
            ...
            <div>
              <IconInput v-model="form.pantones" inputPlaceholder="Pantones" inputType="text">
            ...
            <div class="flex ml-3 col-span-2">
              ...
              <textarea v-model="form.specifications" class="textarea" autocomplete="off"
                placeholder="Requerimientos/Especificaiones"></textarea>
          ...
          <div class="col-span-full">
            <div class="flex items-center">
              ...
              <input @input="form.media_plano = $event.target.files[0]"
          ...
          <div class="col-span-full">
            <div class="flex items-center">
              ...
              <input @input="form.media_logo = $event.target.files[0]"
                class="input h-12 rounded-lg file:mr-4 file:py-1 file:px-2 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white file:cursor-pointer hover:file:bg-red-600"
                aria-describedby="file_input_help" id="file_input" type="file" />
            </div>
            <p class="mt-1 text-xs text-right text-gray-500" id="file_input_help">

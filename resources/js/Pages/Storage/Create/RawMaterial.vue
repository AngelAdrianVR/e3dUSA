      ...
      <form @submit.prevent="store">
        <div class="md:w-1/2 md:mx-auto mx-3 my-5 bg-[#D9D9D9] rounded-lg p-9 shadow-md md:space-y-4">
          ...
          <div class="md:grid gap-x-6 gap-y-2 md:mb-6 grid-cols-2">
            <div>
              <IconInput v-model="form.brand" @change="generatePartNumber" inputPlaceholder="Marca del producto *"
                inputType="text">
            ...
            <div class="flex items-center space-x-2">
              <label class="flex items-center">
                <Checkbox v-model:checked="form.is_catalog_product" class="bg-transparent" />
                <span class="ml-2 text-xs">Es producto de catálogo</span>
              </label>
              <el-tooltip placement="top">
                <template #content>
                  <p>
                    Se refiere a si este producto no requiere algún <br>
                    proceso de producción adicional. <br>
                    Al seleccionar esta opción, el producto se <br>
                    agregará automáticamente al almacén de productos <br>
                    terminados y al catálogo de productos.
                  </p>
                </template>
            ...
            <div>
              <IconInput v-model="form.material" inputPlaceholder="Material *" inputType="text">

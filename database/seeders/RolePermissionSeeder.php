...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'Eliminar oportunidades', 'category' => 'CRM']); //oportunidades (CRM)

        Permission::create(['name' => 'Ver tareas de oportunidades', 'category' => 'CRM']); //tareas de oportunidad (CRM)
        Permission::create(['name' => 'Crear tareas de oportunidades', 'category' => 'CRM']); //tareas de oportunidad (CRM)
        Permission::create(['name' => 'Editar tareas de oportunidades', 'category' => 'CRM']); //tareas de oportunidad (CRM)
        Permission::create(['name' => 'Eliminar tareas de oportunidades', 'category' => 'CRM']); //tareas de oportunidad (CRM)

        Permission::create(['name' => 'Ver seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Crear seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Editar seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Eliminar seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Enviar correos en seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Registrar pagos en seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Agendar citas en seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Registrar interaccion whatsapp en seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        Permission::create(['name' => 'Registrar llamada en seguimiento integral', 'category' => 'CRM']); //seguimiento integral (CRM)
        ...
        Permission::create(['name' => 'Crear ordenes de compra', 'category' => 'Compras']);
        ...
        Permission::create(['name' => 'Ver proyectos', 'category' => 'Generales']); //PMS
        Permission::create(['name' => 'Crear proyectos', 'category' => 'Generales']); //PMS
        Permission::create(['name' => 'Editar proyectos', 'category' => 'Generales']); //PMS
        Permission::create(['name' => 'Eliminar proyectos', 'category' => 'Generales']); //PMS
        Permission::create(['name' => 'Ver tareas', 'category' => 'Generales']); //tareas de proyectos (PMS)
        Permission::create(['name' => 'Crear tareas', 'category' => 'Generales']); //tareas de proyectos (PMS)
        Permission::create(['name' => 'Editar tareas', 'category' => 'Generales']); //tareas de proyectos (PMS)
        Permission::create(['name' => 'Eliminar tareas', 'category' => 'Generales']); //tareas de proyectos (PMS)
